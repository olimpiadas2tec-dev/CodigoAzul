  ...
  return `
    <div class="page-header page-transition">
      <div class="page-header-row">
        ...
        <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;width:auto;">
          <!-- Botón Único Unificado de Exportación con Dropdown -->
          <div id="export-dropdown-container" style="position:relative; display:inline-block; z-index:9999; flex:1 1 auto;">
            <button class="btn btn-outline btn-sm" onclick="toggleExportDropdown()" style="padding:7px 14px; height:38px; width:100%; box-sizing:border-box; font-size:12.5px; font-weight:700; border-radius:8px; display:inline-flex; align-items:center; justify-content:center; gap:6px; background:#ffffff; border:1.5px solid var(--celeste-dark); color:var(--celeste-dark); cursor:pointer;" title="Exportar registro en diferentes formatos">
          ...
          <a href="#/editar/${codigo.id}" class="btn btn-secondary btn-sm" style="height:38px; display:inline-flex; align-items:center; justify-content:center; flex:1 1 auto;">
