                    ...
                    <td style="vertical-align:middle; padding:10px 12px; text-align:center;">
                      ...
                      ` : `
                        <div style="display:flex; gap:14px; justify-content:center; align-items:center;">
                          <button class="action-link" onclick="openMaterialModal(${m.id})" title="Editar Material" style="display:inline-flex; align-items:center; font-weight:700; font-size:13px; color:var(--celeste-dark); text-decoration:none;">
                            Editar
                          </button>
