      ...
      <div class="page-header-row">
        ...
        <div class="page-header-actions">
          ...
          <div id="export-dropdown-container" class="page-action-item" style="position:relative; z-index:9999;">
            <button class="btn btn-outline btn-sm page-action-btn" onclick="toggleExportDropdown()" style="padding:7px 12px; height:38px; width:100%; box-sizing:border-box; font-size:12px; font-weight:700; border-radius:8px; display:inline-flex; align-items:center; justify-content:center; gap:6px; background:#ffffff; border:1.5px solid var(--celeste-dark); color:var(--celeste-dark); cursor:pointer;" title="Exportar registro en diferentes formatos">
          ...
          <a href="#/editar/${codigo.id}" class="btn btn-secondary btn-sm page-action-item page-action-btn" style="height:38px; width:100%; box-sizing:border-box; font-size:12px; font-weight:700; border-radius:8px; display:inline-flex; align-items:center; justify-content:center; gap:6px; text-decoration:none;">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:14px;height:14px;"><path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> Registro
          </a>
        </div>
      </div>
    </div>
